...
class NLIDataModuleMultilanguage(pl.LightningDataModule):
    ...
    def __init__(self, data_source_folder, dataset_name, batch_size = 64, transform = None):
        ...
        # Dataset paths
        self.train_path = os.path.join(self.data_source_folder, dataset_name,'train_dataset_multilanguage.pt')
        self.val_path = os.path.join(self.data_source_folder, dataset_name,'validation_dataset_zero_multilanguage.pt')
        self.test_path = os.path.join(self.data_source_folder, dataset_name,'test_dataset_zero_multilanguage.pt')
