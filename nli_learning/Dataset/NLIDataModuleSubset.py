...
class NLIDataModuleSubset(pl.LightningDataModule):
    ...
    def __init__(self, data_source_folder, subset, dataset_name, batch_size = 64, transform = None):
        super().__init__()
        ...
        self.train_source_data = os.path.join(self.data_source_folder, f'train_{subset}.json')
        ...
        # Dataset paths
        self.train_path = os.path.join(self.data_source_folder, dataset_name,f'{subset}_train_dataset.pt')
        self.val_path = os.path.join(self.data_source_folder, dataset_name,f'{subset}_validation_dataset.pt')
        self.test_path = os.path.join(self.data_source_folder, dataset_name,f'{subset}_test_dataset.pt')
