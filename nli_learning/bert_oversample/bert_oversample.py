...
from nli_learning.bert_multilingual.BertMultilingualClassifier import (
    BertMultilingualClassifier,
)
from nli_learning.bert_oversample.BertOversampleClassifier import (
    BertOversampleClassifier,
)
...
def train_bert_oversample(dataset_path: str, num_epochs: int = 10):
    # mode
    ...
    datamodule = NLIDataModuleOversample(
