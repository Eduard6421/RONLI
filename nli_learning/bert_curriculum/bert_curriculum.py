...
def train_bert_curriculum(dataset_path: str):
    ...
    module_1 = NLIDataModuleCurriculum(train_stage=0, data_source_folder=dataset_path, dataset_name='bert_curriculum_dataset', batch_size=256,transform=get_bert_embedding)
    ...
    module_2 = NLIDataModuleCurriculum(train_stage=1, data_source_folder=dataset_path, dataset_name='bert_curriculum_dataset', batch_size=256,transform=get_bert_embedding)
    ...
    module_3 = NLIDataModuleCurriculum(train_stage=2, data_source_folder=dataset_path, dataset_name='bert_curriculum_dataset', batch_size=256,transform=get_bert_embedding)
    ...
    module_4 = NLIDataModuleCurriculum(train_stage=3, data_source_folder=dataset_path, dataset_name='bert_curriculum_dataset', batch_size=256,transform=get_bert_embedding)
    ...
    module_5 = NLIDataModuleCurriculum(train_stage=4, data_source_folder=dataset_path, dataset_name='bert_curriculum_dataset', batch_size=256,transform=get_bert_embedding)
