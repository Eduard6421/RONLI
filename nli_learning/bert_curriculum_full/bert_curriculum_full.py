...
def train_bert_curriculum_full(dataset_path: str):
    ...
    # First entry at (4190/2)/3.
    # Second entry at (4190/2)/3*2.
    # Third entry at (4190/2)/3*3.
    ...
    module_1 = NLIDataModuleCurriculumFull(
        train_stage=0,
        data_source_folder=dataset_path,
        dataset_name="bert_curriculum_full_dataset",
        batch_size=256,
    ...
    module_2 = NLIDataModuleCurriculumFull(
        train_stage=1,
        data_source_folder=dataset_path,
        dataset_name="bert_curriculum_full_dataset",
        batch_size=256,
    ...
    module_3 = NLIDataModuleCurriculumFull(
        train_stage=2,
        data_source_folder=dataset_path,
        dataset_name="bert_curriculum_full_dataset",
        batch_size=256,
