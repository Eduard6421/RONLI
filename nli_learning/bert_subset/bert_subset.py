...
def train_bertsubset(datamodule: pl.LightningDataModule, dataset_subset,  num_epochs: int):

    BERT_DIR = "bert_checkpoints/ro{}".format(dataset_subset)
    BERT_STATS = "bert_stats/ro{}".format(dataset_subset)
